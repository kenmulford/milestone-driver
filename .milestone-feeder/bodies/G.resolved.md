...
- Edit point: the "What you receive" section header at agents/design-reviewer.md:32. Add one input bullet to the existing list (lines 36-38) naming "the provided `.project/` sections — supplied by the triage design-reviewer dispatch brief (added by #186)". Mirror the existing bullet form.
...
## Dependencies
- Depends on #186 — consumes the .project/ sections the triage design-reviewer dispatch brief supplies, added by #186
