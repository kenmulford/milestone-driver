...
ceiling for this governed path, and at exactly 4000 bytes against its 4000-byte ceiling. Sitting AT both ceilings is
...
at all and exits 0 with an all-OK stream. Its byte count is over 4000, so the byte ceiling fails it and names the
...
twins read the same bytes off disk, so both report 4000 here and neither needs a locale to do it.

## Why the line ceiling holds at 40 while the byte ceiling drops to 4000
...
<!-- padding, sized so this fixture lands on exactly 4000 bytes:  -->
