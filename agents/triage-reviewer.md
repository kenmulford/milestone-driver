...
5. Criterion 2's two-part check, run for real: its search over `sourceGlobs`, the sibling files and the cited `.project/` anchors; **and** its research path - framework docs for the version in use, then `domainSkills`, then repo patterns.
